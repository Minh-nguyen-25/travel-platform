...
export default function AiChatPage() {
  ...
  return (
    <div className="trip-page-bg min-h-screen pb-20">
      <EditorialPageHero
        eyebrow="TravelPlatform AI Chat"
        title={<>Hỏi nhanh. <span className="text-primary-200">Đi tự tin hơn.</span></>}
        description="Trò chuyện cùng trợ lý hiểu sở thích, các chuyến đi đã lưu và danh mục địa điểm của TravelPlatform."
              ...
              {lastResult && (
                <dl className="mt-4 grid grid-cols-2 gap-2 border-t border-gray-100 pt-4 text-center">
                  <div className="rounded-xl bg-gray-50 px-2 py-3">
                    <dt className="text-[10px] font-bold uppercase tracking-wide text-gray-400">Chuyến đi</dt>
                    <dd className="mt-1 text-lg font-extrabold text-gray-900">{lastResult.context.tripCount}</dd>
                  </div>
                  <div className="rounded-xl bg-gray-50 px-2 py-3">
                    <dt className="text-[10px] font-bold uppercase tracking-wide text-gray-400">Địa điểm</dt>
