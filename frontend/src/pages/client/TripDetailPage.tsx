              ...
              {trip.tripDays.map((day) => {
                ...
                return (
                  <button type="button" key={day.id} onClick={() => setSelectedDayId(day.id)} className={`min-w-[138px] flex-1 rounded-xl px-4 py-3 text-left transition-all ${isActive ? 'bg-primary-600 text-white shadow-lg shadow-primary-200' : 'text-gray-600 hover:bg-primary-50 hover:text-primary-700'}`}>
                    <span className={`block text-[10px] font-extrabold uppercase tracking-normal ${isActive ? 'text-primary-100' : 'text-gray-400'}`}>Ngày {day.dayNumber}</span>
          ...
          <div className="mt-8 grid items-start gap-7 lg:grid-cols-[minmax(0,1fr)_310px]">
            <section className="min-w-0">
              <div className="mb-6 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
                <div>
                  <p className="text-xs font-extrabold uppercase tracking-normal text-primary-600">Ngày {selectedDay.dayNumber}</p>
            ...
            <aside className="space-y-5 lg:sticky lg:top-24">
              <div className="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm">
                <div className="bg-gradient-to-r from-primary-700 to-primary-600 px-5 py-4 text-white">
                  <div className="flex items-center justify-between"><p className="text-xs font-bold uppercase tracking-normal text-primary-100">Ngân sách chuyến đi</p><TripIcon name="wallet" size={18} className="text-primary-100" /></div>
              ...
              <div className="rounded-2xl border border-gray-100 bg-white p-5 shadow-sm">
                <p className="text-xs font-extrabold uppercase tracking-normal text-gray-400">Tổng quan</p>
