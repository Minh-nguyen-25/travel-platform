    ...
    <div className="relative isolate flex min-h-[calc(100vh-4.5rem)] items-center overflow-hidden bg-sand-50 px-4 py-16">
      ...
      <div className="container grid items-center gap-12 lg:grid-cols-[0.9fr_1.1fr]">
        <div className="text-center lg:text-left">
          ...
          <p className="font-display font-black select-none text-[clamp(4.5rem,12vw,8rem)] leading-none text-primary-100">404</p>
          <h1 className="display-title mt-2 text-3xl text-navy-900 sm:text-4xl lg:text-5xl leading-tight">Cung đường này chưa được mở.</h1>
          <p className="mx-auto mt-5 max-w-xl text-sm leading-7 text-gray-500 lg:mx-0">
            Có thể trang đã đổi địa chỉ, hoặc bạn vừa rẽ vào một lối đi chưa có trên bản đồ TravelGo.
          </p>
