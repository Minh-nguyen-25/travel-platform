  ...
  return (
    <div className="flex gap-3 border-b border-gray-100 py-4 last:border-0">
      ...
      <div className="min-w-0">
        <p className="text-[11px] font-extrabold uppercase tracking-normal text-gray-400">{label}</p>
    ...
    <div className="min-h-screen overflow-x-hidden bg-white pb-20">
      <EditorialPageHero
        ...
        aside={rating > 0 ? (
          <a href="#reviews" className="flex w-fit items-center gap-3 rounded-2xl border border-white/20 bg-white/12 px-4 py-3 text-white shadow-float backdrop-blur-xl hover:bg-white/20 hover:text-white">
            ...
            <div><p className="text-xl font-black text-white">{rating.toFixed(1)}</p><p className="text-[10px] font-bold uppercase tracking-normal text-white/65">Đánh giá</p></div>
          </a>
        ) : undefined}
      >
      ...
      <div className="container pt-7 sm:pt-9">
        ...
        <div className="mt-8">
          ...
          {coverImage?.startsWith('/images/destinations/') && coverImage.endsWith('.jpg') && (
        ...
        <div className="mt-10 grid items-start gap-8 lg:grid-cols-[minmax(0,1fr)_23rem] lg:gap-12">
          <div className="space-y-10">
            <section>
              <p className="text-xs font-extrabold uppercase tracking-normal text-primary-600">Về địa điểm</p>
            ...
            <section>
              <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                <div>
                  <p className="text-xs font-extrabold uppercase tracking-normal text-primary-600">Vị trí</p>
