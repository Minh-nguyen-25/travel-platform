    ...
    >
      ...
      <div className="space-y-8 px-5 py-6 sm:px-7 sm:py-7">
        ...
        <section aria-labelledby="planner-preferences-heading">
          ...
          <fieldset>
            <legend className="text-xs font-bold uppercase tracking-normal text-gray-500">Hoạt động</legend>
          ...
          <fieldset className="mt-5">
            <legend className="text-xs font-bold uppercase tracking-normal text-gray-500">Loại điểm đến</legend>
            <div className="mt-2.5 flex flex-wrap gap-2">
