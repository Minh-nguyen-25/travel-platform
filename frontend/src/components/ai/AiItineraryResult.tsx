        ...
        <div className="relative">
          ...
          <dl className="mt-7 grid grid-cols-2 gap-3 sm:grid-cols-4">
            <div className="rounded-2xl border border-white/15 bg-white/10 p-3.5 backdrop-blur-sm">
              <dt className="text-[10px] font-bold uppercase tracking-wide text-primary-100">Điểm đến</dt>
            ...
            <div className="rounded-2xl border border-white/15 bg-white/10 p-3.5 backdrop-blur-sm">
              <dt className="text-[10px] font-bold uppercase tracking-wide text-primary-100">Thời lượng</dt>
              <dd className="mt-1.5 flex items-center gap-1.5 text-sm font-extrabold">
                <TripIcon name="calendar" size={15} />{itinerary.days.length} ngày
              </dd>
            </div>
            <div className="rounded-2xl border border-white/15 bg-white/10 p-3.5 backdrop-blur-sm">
              <dt className="text-[10px] font-bold uppercase tracking-wide text-primary-100">Số người</dt>
              <dd className="mt-1.5 flex items-center gap-1.5 text-sm font-extrabold">
                <TripIcon name="users" size={15} />{itinerary.numberOfPeople} người
              </dd>
            </div>
            <div className="rounded-2xl border border-white/15 bg-white/10 p-3.5 backdrop-blur-sm">
              <dt className="text-[10px] font-bold uppercase tracking-wide text-primary-100">Chi phí dự kiến</dt>
              <dd className="mt-1.5 flex items-center gap-1.5 text-sm font-extrabold">
